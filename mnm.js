document.addEventListener("DOMContentLoaded", () => {
  ...
  if (openOccasion) {
    openOccasion.addEventListener("click", () => {
      ...
      document.getElementById("occ_song").value = songForm.querySelector('input[name="entry.1219498112"]').value;
      document.getElementById("occ_artist").value = songForm.querySelector('input[name="entry.1852445536"]').value;
...
if (closeOccasion) {
  ...
  function showSuccessUI(displayName) {
    ...
    successSection.innerHTML = `
      ...
      <div class="socials">
        <a href="https://www.instagram.com/mnmthesingingduo?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="social-btn insta">
          📸 Follow on Instagram
        </a>
      </div>
    `;
